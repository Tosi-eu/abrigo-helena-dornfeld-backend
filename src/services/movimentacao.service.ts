...
import type { PrismaMovementRepository } from '@repositories/movimentacao.repository';
...
import {
  ...
  CreateMovementData,
} from '@domain/movimentacao.types';

export class MovementService {
  constructor(
    private readonly repo: PrismaMovementRepository,
